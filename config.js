...
module.exports = {
  sessionName: process.env.SESSION_ID || "VAJIRA;;;EveryoneSignals",      //Put Your Session Id Here
  botname: process.env.BOT_NAME || 'ishraqch',
  botbgm: process.env.BOT_BGM || 'true',
  ownername:  process.env.OWNER_NAME || `ishraq`,
