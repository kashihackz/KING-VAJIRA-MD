...
module.exports = {
  sessionName: process.env.SESSION_ID || "VAJIRA;;;BetrayLeaders",      //Put Your Session Id Here
  botname: process.env.BOT_NAME || 'ishraq',
  botbgm: process.env.BOT_BGM || 'true',
  ownername:  process.env.OWNER_NAME || `ishtaq`,
